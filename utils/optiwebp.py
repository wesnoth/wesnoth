...
image_dirs = [
    ...
    os.path.join("data", "campaigns", "Heir_To_The_Throne_Classic", "images", "portraits"),
    os.path.join("data", "campaigns", "Heir_To_The_Throne_Classic", "images", "maps"),
    os.path.join("data", "campaigns", "Heir_To_The_Throne_Classic", "images", "story"),
