...
("Compressed Saves", "Compressed saves"),
("Confirm Deleting Saves", "Confirm deleting saves"),
("Mouse Scrolling", "Mouse scrolling"),
("Middle-click Scrolling", "Middle-click scrolling"),
("Keep Scrolling when Mouse Leaves Window", "Keep scrolling when mouse leaves window"),
("Local Time of Day Area Lighting", "Local time of day area lighting"),
("Show Titlescreen Animation", "Show titlescreen animation"),
("Show Combat", "Show combat"),
("Ping Timeout", "Ping timeout"),
("Accept Whispers from Friends Only", "Accept whispers from friends only"),
("Auto-open Whisper Windows in Lobby", "Auto-open whisper windows in lobby"),
("Group Players in Lobby", "Group players in lobby"),
("Lobby Sounds", "Lobby sounds"),
("Disable Notifications", "Disable notifications"),
("Reverse Time Graphics", "Reverse time graphics"),
("Follow Unit Actions", "Follow unit actions"),
("Chat Message Aging", "Chat message aging"),
("Use 12-hour Clock Format", "Use 12-hour clock format"),
("Confirm Loading of Saves from a Different Version", "Confirm loading of saves from a different version"),
("Show All Unit Types in Help", "Show all unit types in help"),
("Joystick Support", "Joystick support"),
("Joystick: Number of the Scroll X-axis Joystick", "Joystick: number of the scroll X-axis joystick"),
("Joystick: Number of the Scroll X-axis", "Joystick: number of the scroll X-axis"),
("Joystick: Number of the Scroll Y-axis Joystick", "Joystick: number of the scroll Y-axis joystick"),
("Joystick: Number of the Scroll Y-axis", "Joystick: number of the scroll Y-axis"),
("Joystick: Deadzone of the Scrolling Stick", "Joystick: deadzone of the scrolling stick"),
("Joystick: Number of the Cursor X-axis Joystick", "Joystick: number of the cursor X-axis joystick"),
("Joystick: Number of the Cursor X-axis", "Joystick: number of the cursor X-axis"),
("Joystick: Number of the Cursor Y-axis Joystick", "Joystick: number of the cursor Y-axis joystick"),
("Joystick: Number of the Cursor Y-axis", "Joystick: number of the cursor Y-axis"),
("Joystick: Deadzone of the Cursor Stick", "Joystick: deadzone of the cursor stick"),
("Joystick: Number of the Mouse X-axis Joystick", "Joystick: number of the mouse X-axis joystick"),
("Joystick: Number of the Mouse X-axis", "Joystick: number of the mouse X-axis"),
("Joystick: Number of the Mouse Y-axis Joystick", "Joystick: number of the mouse Y-axis joystick"),
("Joystick: Number of the Mouse Y-axis", "Joystick: number of the mouse Y-axis"),
("Joystick: Deadzone of the Mouse Stick", "Joystick: deadzone of the mouse stick"),
