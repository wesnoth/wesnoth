...
public class WMLMacroCallImpl extends WMLAbstractMacroCallImpl implements WMLMacroCall
{
   ...
   * @ordered
   */
  protected EList<WMLAbstractKeyValue> params;
   ...
   * @generated
   */
  public EList<WMLAbstractKeyValue> getParams()
  {
    if (params == null)
    {
      params = new EObjectContainmentEList<WMLAbstractKeyValue>(WMLAbstractKeyValue.class, this, WMLPackage.WML_MACRO_CALL__PARAMS);
    }
    return params;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case WMLPackage.WML_MACRO_CALL__PARAMS:
        getParams().clear();
        getParams().addAll((Collection<? extends WMLAbstractKeyValue>)newValue);
        return;
    }
