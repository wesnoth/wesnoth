#!/usr/bin/env bash
# Docker-based test: verify Wesnoth web local hotseat game starts.
# No network proxy needed — this is purely local multiplayer.
#
# Usage: ./test_hotseat_docker.sh [screenshot_dir]
set -euo pipefail
...
echo "=== Wesnoth Web Hotseat Docker Test ==="
