...
CREATE TABLE `builds` (
  ...
  `repo_version` int(11) NOT NULL,
  `time` timestamp NOT NULL default CURRENT_TIMESTAMP,
  `status` int(11) NOT NULL,
  `error_msg` blob NOT NULL,
  PRIMARY KEY  (`id`),
  KEY `time` (`time`),
  KEY `repo_version` (`repo_version`),
