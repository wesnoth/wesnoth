...
Each packet (packet sent from the client to the server) begin with an integer of 4 bytes, the endianess is handle via the pair htonl and ntohl. It contains the size of the metadata (not the binary data).
