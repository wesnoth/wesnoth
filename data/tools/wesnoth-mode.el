...
(defvar wesnoth-tags-list
  (list
   ...
   "case" "choose" "clear_variable" "colour_adjust" "command" "deaths" "defend"
   "defends" "defense" "delay" "destination" "disallow_recruit" "do" "effect"
   "else" "end_turn" "endlevel" "era" "event" "expenses" "filter" 
   "filter_second" "format" "frame" "game_config" "generator" "gold" 
   "have_unit" "header" "hide_unit" "if" "illuminated_time" "image" "img" 
   "income" "italic" "item" "jump" "kill" "killed" "label" "language" 
   "leader_goal" "main_map" "menu" "message" "mini_map" "missile_frame" 
   "modifications" "modify_side" "modify_turns" "move" "move_unit_fake" 
   "movement_costs" "movetype" "multiplayer" "multiplayer_side" "music"
   "not" "num_units" "object" "objectives" "objective" "observers" "option" 
   "or" "panel" "part" "place_shroud" "position" "print" "protect_location" 
   "protect_unit" "race" "random" "recall" "recalls" "recruit" "recruits" 
   "redraw" "ref" "remove_shroud" "remove_unit_overlay" "removeitem" "replay" 
   "replay_start" "resistance" "resolution" "results" "role" "save" "scenario" 
   "scroll" "scroll_to" "scroll_to_unit" "section" "set_recruit" "set_variable"
   "side" "side_playing" "snapshot" "sound" "source" "specials" "statistics"
   "status" "stone" "store_gold" "store_locations" "store_starting_location"
