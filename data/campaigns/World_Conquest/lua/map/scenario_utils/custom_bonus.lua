...
local oceanic_events = wesnoth.require('./../postgeneration_utils/events') -- oceanic function
local engine = wesnoth.require('./../postgeneration_utils/engine') -- f map function
local map_gen = wesnoth.require('./../wct_map_generator.lua') -- f map function
local map_scen_1 = wesnoth.require('./../scenarios/WC_II_1p_scenario1.lua') -- start map function
