...
public:
	...
	bool get_special_bool_id(const std::string& special, bool simple_check=false) const;
	bool get_special_bool_tags(const std::string& special, bool simple_check=false) const;
