...
public:
	...
	static specials_coontext_t make(specials_combatant&& self, specials_combatant&& other, bool attacking)
	{
	...
	static specials_coontext_t make_for_listing(specials_combatant&& self, bool attacking = true)
	{
		//TODO:
		return make(std::move(self), {}, attacking);
	}
