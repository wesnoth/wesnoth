...
bool frame_parsed_parameters::need_update() const
{
	...
	//TODO: optimize by caching the pixel screen location and only update if screen moved (scrolls). Like:
	// const point& test = display::get_singleton()->get_location({ 0,0 };
