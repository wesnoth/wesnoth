...
std::string attack_type::weapon_specials_value(const std::set<std::string> checking_tags) const
{
	...
	add_name_list(temp_string, weapon_abilities, checking_name, translation::dsgettext("wesnoth", "Owned: "));
	...
	add_name_list(temp_string, weapon_abilities, checking_name, translation::dsgettext("wesnoth", "Taught: "));
	...
	add_name_list(temp_string, weapon_abilities, checking_name, translation::dsgettext("wesnoth", "Taught: (by an enemy): "));
	...
	add_name_list(temp_string, weapon_abilities, checking_name, translation::dsgettext("wesnoth", "Used by opponent: "));
