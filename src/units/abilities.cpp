	...
	composite_value_(0)
{
	...
	/* Using 'substraction' independant of 'addition' for abilities with same id and 'add' and 'sub'
	 * for what rule of calculation was base+ add_value - sub_value
	 * instead of base + (add_value or -sub_value).
	 */
	int substraction = 0;
