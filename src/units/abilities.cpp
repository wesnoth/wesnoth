...
bool foreach_active_special(
	const specials_coontext_t& context,
	const specials_coontext_t::specials_combatant& self,
 ...
 */
std::string specials_coontext_t::describe_weapon_specials(const attack_type& at) const
{
...
std::string specials_coontext_t::describe_weapon_specials_value(const attack_type& at, const std::set<std::string>& checking_tags) const
{
	auto [self, other] = self_and_other(at);
 ...
 */
std::vector<unit_ability_t::tooltip_info> specials_coontext_t::special_tooltips(const attack_type& at,
...
namespace {
	 ...
	 * @param ab                the ability/special
	 */
	bool special_tooltip_active(const specials_coontext_t& context, const specials_coontext_t::specials_combatant& self, const unit_ability_t& ab)
	{
		//TODO:
...
std::vector<unit_ability_t::tooltip_info> specials_coontext_t::abilities_special_tooltips(const attack_type& at,
	boost::dynamic_bitset<>& active_list) const
{
	auto [self, other] = self_and_other(at);
	std::vector<unit_ability_t::tooltip_info> res;
 ...
 */
bool specials_coontext_t::has_active_special(const attack_type & at, const std::string & tag_name) const
{
...
bool specials_coontext_t::has_active_special_id(const attack_type& at, const std::string& special_id) const
{
...
active_ability_list specials_coontext_t::get_active_combat_teachers(const attack_type& at) const
{
	auto [self, other] = self_and_other(at);
...
active_ability_list specials_coontext_t::get_active_specials(const attack_type& at, const std::string& tag_name) const
{
	auto [self, other] = self_and_other(at);
	const map_location loc = self.un ? self.un->get_location() : self.loc;
...
active_ability_list specials_coontext_t::get_abilities_weapons(const std::string& tag_name, const unit& un) const
{
...
bool specials_coontext_t::has_active_special_matching_filter(const attack_type& at, const config & filter) const
{
	if(at.range().empty()){
		return false;
	}
 ...
 */
bool specials_coontext_t::is_special_active(const specials_combatant& self, const unit_ability_t& ab, unit_ability_t::affects_t whom) const
{
