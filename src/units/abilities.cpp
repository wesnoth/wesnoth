                                   ...
                                   unsigned & max_attacks) const
{
	...
	unit_abilities::effect attacks_effect(get_specials_and_abilities("attacks"),
	                                      num_attacks(), false, shared_from_this());
...
{
	unit_abilities::effect dmg_effect(get_specials_and_abilities("damage"), damage(), false, shared_from_this());
...
effect::effect(const unit_ability_list& list, int def, bool is_cumulable, const_attack_ptr att) :
	effect_list_(),
	composite_value_(0)
{
