...
std::pair<std::string, int> attack_type::select_alternative_type(const unit_ability_list& damage_type_list, unit_ability_list resistance_list) const
{
...
std::pair<std::string, int> attack_type::effective_damage_type() const
{
	...
	if(other_){
		...
		type_damage = alternative_type.second > first_value ? alternative_type.first : type_damage;
		res = std::max(first_value, alternative_type.second);
	}
