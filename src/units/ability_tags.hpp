...
struct ability_list_defines
{
	...
	static constexpr const char* const chance_to_parry = "chance_to_parry";
	...
	ENUM_AND_ARRAY(heals, regenerate, resistance, leadership, skirmisher, illuminates, teleport, hides, dummy, attacks, berserk, chance_to_hit, damage, damage_type, chance_to_parry, disable, drains, firststrike, heal_on_hit, petrifies, plague, poison, slow, swarm)

	static const std::set<std::string>& weapon_number_tags()
	{
		static std::set<std::string> tags{attacks, damage, chance_to_parry, chance_to_hit, berserk, swarm, drains, heal_on_hit};
		return tags;
	}
	static const std::set<std::string>& weapon_inverse_affect_tags()
	{
		static std::set<std::string> tags{chance_to_parry};
		return tags;
	}
	...
	{
		static std::set<std::string> tags{attacks, berserk, chance_to_hit, damage, damage_type, chance_to_parry, disable, drains, firststrike, heal_on_hit, petrifies, plague, poison, slow, swarm};
		return tags;
	}
};
