...
static int64_t ifs_size (struct SDL_IOStream * context);
static int64_t ofs_size (struct SDL_IOStream * context);
static int64_t SDLCALL ifs_seek(struct SDL_IOStream *context, int64_t offset, int whence);
static int64_t SDLCALL ofs_seek(struct SDL_IOStream *context, int64_t offset, int whence);
static std::size_t SDLCALL ifs_read(struct SDL_IOStream *context, void *ptr, std::size_t size, std::size_t maxnum);
static std::size_t SDLCALL ofs_read(struct SDL_IOStream *context, void *ptr, std::size_t size, std::size_t maxnum);
static std::size_t SDLCALL ifs_write(struct SDL_IOStream *context, const void *ptr, std::size_t size, std::size_t num);
static std::size_t SDLCALL ofs_write(struct SDL_IOStream *context, const void *ptr, std::size_t size, std::size_t num);
static int SDLCALL ifs_close(struct SDL_IOStream *context);
static int SDLCALL ofs_close(struct SDL_IOStream *context);

void sdl_rwops_deleter::operator()(SDL_IOStream* p) const noexcept
{
	SDL_FreeRW(p);
}
