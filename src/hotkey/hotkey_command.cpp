...
hotkey_command_temp hotkey_list_[] {
	...
	{ HOTKEY_MUTE, "mute", N_("Mute All"), false, scope_game | scope_editor | scope_main, HKCAT_GENERAL, "" },
	{ HOTKEY_MUTE_MUSIC, "mutemusic", N_("Mute Music"), false, scope_game | scope_editor | scope_main, HKCAT_GENERAL, "" },
