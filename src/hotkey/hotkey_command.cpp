...
constexpr std::array<hotkey_command_temp, HOTKEY_NULL - 1> master_hotkey_list {{
	...
	{ HOTKEY_EDITOR_SAVE_AS, "editor-save-as", N_("Save As"), false, scope_editor, HKCAT_MAP, "" },
	{ HOTKEY_EDITOR_SAVE_MAP_AS_SCENARIO, "editor-save-map-as-scenario", N_("Save Map As Scenario"), false, scope_editor, HKCAT_SCENARIO, "" },
