...
namespace {
	...
	static void wml_func_kill(event_handler& handler, const queued_event& event_info, const vconfig& cfg)
	{
	...
	{
		function_call_map.insert(std::make_pair("teleport", &wml_func_teleport));
		function_call_map.insert(std::make_pair("unstone", &wml_func_unstone));
		function_call_map.insert(std::make_pair("allow_recruit", &wml_func_allow_recruit));
		function_call_map.insert(std::make_pair("disallow_recruit", &wml_func_disallow_recruit));
		function_call_map.insert(std::make_pair("set_recruit", &wml_func_set_recruit));
		function_call_map.insert(std::make_pair("music", &wml_func_music));
		function_call_map.insert(std::make_pair("sound", &wml_func_sound));
		function_call_map.insert(std::make_pair("colour_adjust", &wml_func_colour_adjust));
		function_call_map.insert(std::make_pair("remove_shroud", &wml_func_remove_shroud));
		function_call_map.insert(std::make_pair("place_shroud", &wml_func_place_shroud));
		function_call_map.insert(std::make_pair("delay", &wml_func_delay));
		function_call_map.insert(std::make_pair("scroll", &wml_func_scroll));
		function_call_map.insert(std::make_pair("scroll_to", &wml_func_scroll_to));
		function_call_map.insert(std::make_pair("scroll_to_unit", &wml_func_scroll_to_unit));
		function_call_map.insert(std::make_pair("gold", &wml_func_gold));
		function_call_map.insert(std::make_pair("modify_side", &wml_func_modify_side));
		function_call_map.insert(std::make_pair("store_side", &wml_func_store_side));
		function_call_map.insert(std::make_pair("store_gold", &wml_func_store_gold));
		function_call_map.insert(std::make_pair("modify_turns", &wml_func_modify_turns));
		function_call_map.insert(std::make_pair("store_turns", &wml_func_store_turns));
		function_call_map.insert(std::make_pair("move_unit_fake", &wml_func_move_unit_fake));
		function_call_map.insert(std::make_pair("objectives", &wml_func_objectives));
		function_call_map.insert(std::make_pair("set_variable", &wml_func_set_variable));
		function_call_map.insert(std::make_pair("set_variables", &wml_func_set_variables));
		function_call_map.insert(std::make_pair("role", &wml_func_role));
		function_call_map.insert(std::make_pair("removeitem", &wml_func_removeitem));
		function_call_map.insert(std::make_pair("remove_unit_overlay", &wml_func_remove_unit_overlay));
		function_call_map.insert(std::make_pair("unit_overlay", &wml_func_unit_overlay));
		function_call_map.insert(std::make_pair("hide_unit", &wml_func_hide_unit));
		function_call_map.insert(std::make_pair("unhide_unit", &wml_func_unhide_unit));
		function_call_map.insert(std::make_pair("item", &wml_func_item));
		function_call_map.insert(std::make_pair("sound_source", &wml_func_sound_source));
		function_call_map.insert(std::make_pair("remove_sound_source", &wml_func_remove_sound_source));
		function_call_map.insert(std::make_pair("terrain_mask", &wml_func_terrain_mask));
		function_call_map.insert(std::make_pair("terrain", &wml_func_terrain));
		function_call_map.insert(std::make_pair("unit", &wml_func_unit));
		function_call_map.insert(std::make_pair("recall", &wml_func_recall));
		function_call_map.insert(std::make_pair("object", &wml_func_object));
		function_call_map.insert(std::make_pair("print", &wml_func_print));
		function_call_map.insert(std::make_pair("deprecated_message", &wml_func_deprecated_message));
		function_call_map.insert(std::make_pair("debug_message", &wml_func_debug_message));
		function_call_map.insert(std::make_pair("kill", &wml_func_kill));
		function_call_map.insert(std::make_pair("fire_event", &wml_func_fire_event));
		function_call_map.insert(std::make_pair("set_menu_item", &wml_func_set_menu_item));
		function_call_map.insert(std::make_pair("store_unit", &wml_func_store_unit));
		function_call_map.insert(std::make_pair("unstore_unit", &wml_func_unstore_unit));
		function_call_map.insert(std::make_pair("store_map_dimesions", &wml_func_store_map_dimensions));
		function_call_map.insert(std::make_pair("store_starting_location", &wml_func_store_starting_location));
		function_call_map.insert(std::make_pair("store_villages", &wml_func_store_villages));
		function_call_map.insert(std::make_pair("store_locations", &wml_func_store_locations));
		function_call_map.insert(std::make_pair("capture_village", &wml_func_capture_village));
		function_call_map.insert(std::make_pair("clear_variable", &wml_func_clear_variable));
		function_call_map.insert(std::make_pair("endlevel", &wml_func_endlevel));
		function_call_map.insert(std::make_pair("redraw", &wml_func_redraw));
		function_call_map.insert(std::make_pair("animate_unit", &wml_func_animate_unit));
		function_call_map.insert(std::make_pair("label", &wml_func_label));
		function_call_map.insert(std::make_pair("heal_unit", &wml_func_heal_unit));
		function_call_map.insert(std::make_pair("command", &wml_func_command));
		function_call_map.insert(std::make_pair("allow_undo", &wml_func_allow_undo));
