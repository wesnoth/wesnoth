	...
	, plague_type()
{
	...
	unit_abilities::effect cth_effects(cth_specials, cth, false, weapon);
	...
	if(drains) {
		...
		unit_abilities::effect drain_percent_effects(drain_specials, 50, false, weapon);
	...
	unit_abilities::effect heal_on_hit_effects(heal_on_hit_specials, 0, false, weapon);
...
int under_leadership(const unit &u, const map_location& loc, const_attack_ptr weapon, const_attack_ptr opp_weapon)
{
	...
	unit_abilities::effect leader_effect(abil, 0, true);
