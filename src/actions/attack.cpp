...
/// for example, if a unit possesses the poison attack but is adjacent to a unit that has the poison leadership ability 
/// that excludes that specific unit, it will still be able to use its own special attack.
...
/// If for chance_to_hit and most others, the value returned when the ability does not exist
/// is the base value calculated previously, for drains where the base value is 50 when it is not specified,
