		...
		double harm_weight)
{
	...
	a = (us_a.average_hp() - poison_a_us) * harm_weight - (them_a.average_hp() * attack_weight_a - poison_a_them);
	b = (us_b.average_hp() - poison_b_us) * harm_weight - (them_b.average_hp() * attack_weight_b - poison_b_them);
