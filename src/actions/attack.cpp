	...
	, plague_type()
{
	...
	auto ctx = specials_coontext_t::make({ up, u_loc, weapon }, { oppp, opp_loc, opp_weapon }, attacking);
...
void attack::fire_event_impl(const std::string& n, bool reverse)
{
	...
	auto ctx = specials_coontext_t::make({ nullptr, a_.loc_, a_stats_->weapon }, { nullptr, d_.loc_, d_stats_->weapon }, true);
...
int under_leadership(const unit& u, const specials_coontext_t& context)
{
