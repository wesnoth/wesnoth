...
BOOST_AUTO_TEST_CASE(test_formula_function_substring)
{
	...
	lg::set_log_domain_severity("scripting/formula", 0);//err
	...
	lg::set_log_domain_severity("scripting/formula", 3);//debug
	...
	lg::set_log_domain_severity("scripting/formula", -1); // Don't log anything
