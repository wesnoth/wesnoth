...
game_info::game_info(const config& game, const std::vector<std::string>& installed_addons)
	...
	, map_size_info()
	, era()
	, ranked_mode(game["ranked_mode"].to_bool(false))
	, tournament_id(game["tournament_id"].str())
	, tournament_name(game["tournament_name"].str())
	, tournament_phase_name(game["tournament_phase_name"].str())
	, tournament_group_name(game["tournament_group_name"].str())
	, tournament_round_number(game["tournament_round_number"].str())
	, tournament_game_number(game["tournament_game_number"].str())
