...
language_def known_languages[] = {
	...
	language_def("de_DE", "Deutsch (99% / 99%)"),
	language_def("en_GB", "English [GB]"),
	language_def("fr_FR", "Français (98% / 98%)"),
	language_def("sv_SE", "Svenska"),
	language_def("es_ES", "Español (partial: 99% / 87%)"),
	language_def("hu_HU", "Magyar (partial: 99% / 80%)"),
	language_def("ja_JP", "日本語 (Nihongo) (partial: 98% / 62%)"),
	language_def("bg_BG", "Български (Bulgarski) (incomplete: 19% / 11%)"),
	language_def("ca_ES", "Català (incomplete: 93% / 77%)"),
	language_def("da_DK", "Dansk (incomplete: 75% / 60%)"),
	language_def("et_EE", "Eesti (incomplete: 53% / 45%)"),
	language_def("el_GR", "Ελληνικά (Ellinika) (incomplete: 15% / 8%)"),
	language_def("eu_ES", "Euskera (incomplete: 38% / 24%)"),
	language_def("it_IT", "Italiano (incomplete: 95% / 97%)"),
	language_def("la_IT", "Latina (incomplete: 90% / 55%)"),
	language_def("nl_NL", "Nederlands (incomplete: 97% / 98%)"),
	language_def("no_NO", "Norsk (incomplete: 77% / 55%)"),
	language_def("pl_PL", "Polski (incomplete: 66% / 48%)"),
	language_def("pt_BR", "Português do Brasil (incomplete: 82% / 74%)"),
	language_def("ru_RU", "Русский (Russkij) (incomplete: 94% / 88%)"),
	language_def("sk_SK", "Slovenčina (incomplete: 87% / 68%)"),
	language_def("sl_SI", "Slovenščina (incomplete: 67% / 54%)"),
	language_def("sr_CS", "Srpski (incomplete: 16% / 10%)"),
	language_def("fi_FI", "Suomi (incomplete: 80% / 48%)"),
	language_def("tr_TR", "Türkçe (incomplete: 33% / 23%)"),
	language_def("zh_CN", "中文 (Zhongwen) (incomplete: 35% / 20%)"),
	language_def("cs_CZ", "Čeština (incomplete: 78% / 75%)"),
