...
public:
	...
	std::vector<boost::shared_ptr<unit> >& recall_list() {return recall_list_;}
	const std::vector<boost::shared_ptr<unit> >& recall_list() const {return recall_list_;}
...
private:
	...
	std::vector<boost::shared_ptr<unit> > recall_list_;
