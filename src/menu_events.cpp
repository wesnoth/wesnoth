...
typedef std::pair<const unit_type*, const unit_gender*> type_and_gender;
...
type_and_gender choose_unit()
{
	...
	if(create_dlg.no_choice()) {
		return type_and_gender(nullptr, nullptr);
	}
...
void create_and_place(game_display&,
		...
		const unit_gender* gender = nullptr)
{
