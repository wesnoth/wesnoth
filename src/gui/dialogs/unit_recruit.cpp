...
void tunit_recruit::pre_show(window& window)
{
...
void tunit_recruit::list_item_clicked(window& window)
{
...
void tunit_recruit::show_help(window& window)
{
	help::show_help(window.video(), "recruit_and_recall");
}

void tunit_recruit::post_show(window& window)
{
