...
void addon_server_info::addon_count_by_type()
{
	std::map<std::string, int> counts = client_.get_addon_count_by_type();
	for(const auto& count : counts) {
		PLAIN_LOG << count.first << ": " << count.second;
	}
}
...
// TODO: hide add-on button as well
