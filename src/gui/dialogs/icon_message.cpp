...
twindow* ticon_message_right::build_window(CVideo& video) {
	return build(video, get_id(ICON_MESSAGE_RIGHT));
}

twindow* toption_message_left::build_window(CVideo& video) {
	return build(video, get_id(OPTION_MESSAGE_LEFT));
}

twindow* toption_message_right::build_window(CVideo& video) {
	return build(video, get_id(OPTION_MESSAGE_RIGHT));
}

twindow* tinput_message_left::build_window(CVideo& video) {
	return build(video, get_id(INPUT_MESSAGE_LEFT));
}

twindow* tinput_message_right::build_window(CVideo& video) {
	return build(video, get_id(INPUT_MESSAGE_RIGHT));
}

twindow* trecall_message_left::build_window(CVideo& video) {
	return build(video, get_id(RECALL_MESSAGE_LEFT));
}

twindow* trecall_message_right::build_window(CVideo& video) {
	return build(video, get_id(RECALL_MESSAGE_RIGHT));
}

twindow* trecruit_message_right::build_window(CVideo& video) {
	return build(video, get_id(RECRUIT_MESSAGE_RIGHT));
}

twindow* trecruit_message_left::build_window(CVideo& video) {
	return build(video, get_id(RECRUIT_MESSAGE_LEFT));
}

twindow* tunit_message_left::build_window(CVideo& video) {
	return build(video, get_id(UNIT_MESSAGE_LEFT));
}
