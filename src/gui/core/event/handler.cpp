...
void sdl_event_handler::mouse_button_up(const point& position, const uint8_t button)
{
	switch(button) {
		...
		case SDL_BUTTON_RIGHT:
			...
			break;
		case SDL_BUTTON_X1:
			mouse(FORWARD_BUTTON_UP, position);
			break;
		case SDL_BUTTON_X2:
			mouse(BACK_BUTTON_UP, position);
			break;
		default:
#ifdef GUI2_SHOW_UNHANDLED_EVENT_WARNINGS
...
void sdl_event_handler::mouse_button_down(const point& position, const uint8_t button)
{
	switch(button) {
		...
		case SDL_BUTTON_RIGHT:
			...
			break;
		case SDL_BUTTON_X1:
			mouse(FORWARD_BUTTON_DOWN, position);
			break;
		case SDL_BUTTON_X2:
			mouse(BACK_BUTTON_DOWN, position);
			break;
		default:
#ifdef GUI2_SHOW_UNHANDLED_EVENT_WARNINGS
...
std::ostream& operator<<(std::ostream& stream, const ui_event event)
{
	switch(event) {
		...
		case FORWARD_BUTTON_DOWN:
			stream << "forward/4 button down";
			break;
		case FORWARD_BUTTON_UP:
			stream << "forward/4 button up";
			break;
		case FORWARD_BUTTON_CLICK:
			stream << "forward/4 button click";
			break;
		case BACK_BUTTON_DOWN:
			stream << "back/5 button down";
			break;
		case BACK_BUTTON_UP:
			stream << "back/5 button up";
			break;
		case BACK_BUTTON_CLICK:
			stream << "back/5 button click";
			break;
		case SDL_WHEEL_LEFT:
