...
bool dispatcher::has_event(const event_t event, const event_queue_type event_type)
{
#if 0
 ...
 *
 * - gui2::event::handler handles the SDL events.
 ...
 * by the @ref gui2::event::handler class. Instead we directly jump to this
 * class and explain what it does.
 *
 * The main handling function is @ref gui2::event::handler::handle_event which
